...
% Modified for SPMMouse by Stephen Sawiak 6/2/2008
% All debug flags set to 1
...
def_flags.estimate.cutoff = 2; % changed from 30 
def_flags.estimate.samp   = 0.15; %cahnged from 3 to mouse brain
def_flags.estimate.bb     =  [[-83 83]' [-116 116]' [-68 68]']; %[[-88 88]' [-122 86]' [-60 95]']; % for mouse atlas
def_flags.estimate.affreg.smosrc = 0.4; % 8mm divided by 20 for mouse brain 
def_flags.estimate.affreg.regtype = 'none'; % changed from mni
