...
regtype = mnu('Affine Regularisation','regtype',...
   {'No Affine Registration','ICBM space template', 'Average sized template','ANIMAL toolbox template','No regularisation'},...
   {'','mni','subj','animal','none'});
...
'the original.  You can also produce spatially normalised versions - both with (wc*) and without (mwc*) ',...
